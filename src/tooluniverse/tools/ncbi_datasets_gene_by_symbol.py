...
Retrieve gene metadata from NCBI Datasets API using gene symbols and taxonomic identifier. Useful...
"""
...
def ncbi_datasets_gene_by_symbol(
    symbols: str,
    taxon: str,
    ...
    *,
    ...
    symbols : str
        One or more gene (e.g., 'BRCA1', or ['BRCA1', 'BRCA2'])
    taxon : str
...
__all__ = ["ncbi_datasets_gene_by_symbol"]
