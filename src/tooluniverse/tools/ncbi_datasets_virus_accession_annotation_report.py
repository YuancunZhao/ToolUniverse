...
def ncbi_datasets_virus_accession_annotation_report(
    accessions: str,
    ...
    *,
    ...
    ----------
    accessions : str
        One or more genome (e.g., 'NM_021803.4' or ['NM_021803.4', 'NM_000546.6'])
    ...
    return get_shared_client().run_one_function(
        {
            "name": "ncbi_datasets_virus_accession_annotation_report",
            "arguments": _args,
        },
...
__all__ = ["ncbi_datasets_virus_accession_annotation_report"]
