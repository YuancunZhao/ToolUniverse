...
def ncbi_datasets_gene_symbol_taxon_product_report(
    symbols: str,
    taxon: str,
    ...
    *,
    ...
    return get_shared_client().run_one_function(
        {
            "name": "ncbi_datasets_gene_symbol_taxon_product_report",
            "arguments": _args,
        },
...
__all__ = ["ncbi_datasets_gene_symbol_taxon_product_report"]
