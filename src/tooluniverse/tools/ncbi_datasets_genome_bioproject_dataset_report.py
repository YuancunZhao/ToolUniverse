...
def ncbi_datasets_genome_bioproject_dataset_report(
    bioprojects: str,
    ...
    *,
    ...
    ----------
    bioprojects : str
        One or more bioprojects (e.g., 'PRJNA489243' or ['PRJNA489243', 'PRJNA248792'])
    ...
    return get_shared_client().run_one_function(
        {
            "name": "ncbi_datasets_genome_bioproject_dataset_report",
            "arguments": _args,
        },
...
__all__ = ["ncbi_datasets_genome_bioproject_dataset_report"]
