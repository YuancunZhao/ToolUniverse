...
def ncbi_datasets_gene_symbol_taxon_dataset_report(
    symbols: str,
    taxon: str,
    ...
    *,
    ...
    return get_shared_client().run_one_function(
        {
            "name": "ncbi_datasets_gene_symbol_taxon_dataset_report",
            "arguments": _args,
        },
...
__all__ = ["ncbi_datasets_gene_symbol_taxon_dataset_report"]
