...
def ncbi_datasets_gene_locus_tag_dataset_report(
    locus_tags: str,
    ...
    *,
    ...
    locus_tags : str
        One or more gene (e.g., 'b0001' or ['b0001', 'b0002'])
    ...
    return get_shared_client().run_one_function(
        {
            "name": "ncbi_datasets_gene_locus_tag_dataset_report",
            "arguments": _args,
        },
...
__all__ = ["ncbi_datasets_gene_locus_tag_dataset_report"]
