...
def ncbi_datasets_genome_assembly_name_dataset_report(
    assembly_names: str,
    ...
    *,
    ...
    ----------
    assembly_names : str
        One or more assembly names (e.g., 'GRCh38' or ['GRCh38', 'GRCh37'])
...
__all__ = ["ncbi_datasets_genome_assembly_name_dataset_report"]
