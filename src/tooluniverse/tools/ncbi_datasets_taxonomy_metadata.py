...
Retrieve taxonomy metadata from NCBI Datasets API using NCBI Taxonomy IDs or names. Returns infor...
"""
...
def ncbi_datasets_taxonomy_metadata(
    taxons: str,
    ...
    *,
    ...
    ----------
    taxons : str
        One or more parameter: (e.g., '9606' for human, or ['9606', '10090'] for huma...
...
__all__ = ["ncbi_datasets_taxonomy_metadata"]
