...
Retrieve genome assembly reports from NCBI Datasets API by assembly accessions. Returns comprehen...
"""
...
def ncbi_datasets_genome_report(
    accessions: str,
    ...
    *,
    ...
    ----------
    accessions : str
        One or more parameter: (e.g., 'NM_021803.4' or ['NM_021803.4', 'NM_000546.6'])
    ...
    filters_is_metagenome_derived : str
        Parameter: filters.is_metagenome_derived
    ...
    filters_type_material_category : str
        Parameter: filters.type_material_category
...
__all__ = ["ncbi_datasets_genome_report"]
