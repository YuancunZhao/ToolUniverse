...
def ncbi_datasets_genome_biosample_dataset_report(
    biosample_ids: str,
    ...
    *,
    ...
    ----------
    biosample_ids : str
        One or more biosample ids (e.g., 'SAMN02953835' or ['SAMN02953835', 'SAMN0295...
    ...
    return get_shared_client().run_one_function(
        {
            "name": "ncbi_datasets_genome_biosample_dataset_report",
            "arguments": _args,
        },
...
__all__ = ["ncbi_datasets_genome_biosample_dataset_report"]
