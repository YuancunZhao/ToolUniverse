...
This skill does not assign ACMG evidence codes. It extracts facts from figures, captions, OCR text, and surrounding article text. Evidence-specific skills such as `tooluniverse-acmg-pm3-in-trans-refinement`, `tooluniverse-acmg-pp1-segregation-refinement`, `tooluniverse-acmg-ps3-bs3-functional-assay-refinement`, and `tooluniverse-acmg-pvs1-splicing-refinement` decide whether and how the evidence affects classification.
...
Use for PS3/BS3 extraction, then pass to `tooluniverse-acmg-ps3-bs3-functional-assay-refinement`.
...
Do not convert RNA figure extraction directly into `PVS1_Strength (RNA)`; pass the structured result to `tooluniverse-acmg-pvs1-splicing-refinement`.
...
- `tooluniverse-acmg-pm3-in-trans-refinement`
- `tooluniverse-acmg-pp1-segregation-refinement`
- `tooluniverse-acmg-ps3-bs3-functional-assay-refinement`
- `tooluniverse-acmg-pvs1-splicing-refinement`
- `tooluniverse-acmg-ps1-splicing-similarity-refinement`
